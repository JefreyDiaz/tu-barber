...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen min-h-[100dvh] w-full overflow-hidden">
      {/* Video de fondo (igual que la home) */}
      <video
        autoPlay
        loop
        muted
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-lg border border-white/20 bg-white/10 px-4 py-3 pr-12 text-white placeholder-white/40 backdrop-blur-sm focus:border-white/40 focus:outline-none focus:ring-2 focus:ring-white/20"
