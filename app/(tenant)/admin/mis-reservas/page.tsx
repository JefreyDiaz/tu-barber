...
export default function MisReservasPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-neutral-800">Mis Reservas</h1>
        <p className="text-neutral-500 mt-1">Gestiona tus citas programadas</p>
      </div>
                          ...
                          return (
                            <div key={booking.id} className={`flex items-start sm:items-center justify-between px-4 py-3 gap-4 ${isPastToday ? 'opacity-60 bg-neutral-50' : ''}`}>
                              <div className="flex items-center gap-4">
                                ...
                                <div>
                                  <p className={`font-medium ${isPastToday ? 'text-neutral-600' : 'text-neutral-800'}`}>{booking.customerName}</p>
                                  <p className="text-sm text-neutral-500">{booking.customerPhone}</p>
                                </div>
                              </div>
                              {!isPastToday && (
                                <button
                      ...
                      {getSortedBookings(groupedBookings[dateKey]).map((booking) => (
                          <div key={booking.id} className="flex items-center px-4 py-3">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <p className="font-medium text-neutral-600">{booking.customerName}</p>
